...
├──────────────────────┼──────────────────────────┼──────────────────────────────┤
│                      │                          │                              │
│   [*] NEXUS          │ [Status] [Memory] [Page] │                              │
│   Neural PDF Engine  │                          │                              │
│                      ├──────────────────────────┤  [< Prev] Page N/M [Next >]  │
│   [Source]           │                          │                              │
│   File name card     │   [User]  message text   │  +------------------------+  │
│   Reset Session btn  │                          │  |                        |  │
│                      │   [AI]    answer text    │  |    PDF page rendered   |  │
│   [Appearance]       │          conf. pill      │  |       as image         |  │
│   Highlight theme    │          page  pill      │  |                        |  │
│                      │                          │  +------------------------+  │
│   [Developer]        │   [ type your query ]    │                              │
│   Debug toggle       │                          │                              │
│                      │                          │                              │
│   [Download PDF]     │                          │                              │
│                      │                          │                              │
